...
var ruleNames =  [ "source_text", "modules", "module_main", "module", "module_ports", 
                   ...
                   "statement_block", "concatenation", "expression", "expr", 
...
vlgParser.GTE = 62;
vlgParser.EQUAL = 63;
vlgParser.NOTEQUAL = 64;
vlgParser.One_line_comment = 65;
vlgParser.Block_comment = 66;
vlgParser.IDENTIFIER = 67;
vlgParser.White_space = 68;
...
vlgParser.RULE_statement_block = 33;
vlgParser.RULE_concatenation = 34;
vlgParser.RULE_expression = 35;
vlgParser.RULE_expr = 36;
vlgParser.RULE_binary_gate_op = 37;
vlgParser.RULE_unary_gate_op = 38;
...
vlgParser.prototype.seq_block = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===vlgParser.T__12 || _la===vlgParser.T__36 || _la===vlgParser.IDENTIFIER) {
            this.state = 304;
            this.statement();
            this.state = 309;
            this._errHandler.sync(this);
...
vlgParser.prototype.statement_block = function() {
    ...
    this.enterRule(localctx, 66, vlgParser.RULE_statement_block);
    try {
        this.state = 333;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
vlgParser.prototype.concatenation = function() {
    ...
    this.enterRule(localctx, 68, vlgParser.RULE_concatenation);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 335;
...
vlgParser.prototype.expression = function(_p) {
    ...
    var _startState = 70;
    this.enterRecursionRule(localctx, 70, vlgParser.RULE_expression, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 356;
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 3:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(((((_la - 59)) & ~0x1f) == 0 && ((1 << (_la - 59)) & ((1 << (vlgParser.LT - 59)) | (1 << (vlgParser.LTE - 59)) | (1 << (vlgParser.GT - 59)) | (1 << (vlgParser.GTE - 59)) | (1 << (vlgParser.EQUAL - 59)) | (1 << (vlgParser.NOTEQUAL - 59)))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
...
vlgParser.prototype.expr = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 72;
    this.enterRecursionRule(localctx, 72, vlgParser.RULE_expr, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 381;
        this._errHandler.sync(this);
...
vlgParser.prototype.binary_gate_op = function() {
    ...
    this.enterRule(localctx, 74, vlgParser.RULE_binary_gate_op);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 392;
...
vlgParser.prototype.unary_gate_op = function() {
    ...
    this.enterRule(localctx, 76, vlgParser.RULE_unary_gate_op);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 394;
