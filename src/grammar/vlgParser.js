...
var ruleNames =  [ "source_text", "modules", "module_main", "module", "module_ports", 
                   ...
                   "reg_declaration", "module_instantiation", "module_connections_list", 
                   "named_port_connection", "gate_instantiation", "gate_type", 
                   "continuous_assign", "list_of_net_assignments", "net_assignment", 
                   "expr", "binary_gate_op", "initial_construct", "always_construct", 
...
vlgParser.RULE_module_instantiation = 16;
vlgParser.RULE_module_connections_list = 17;
vlgParser.RULE_named_port_connection = 18;
vlgParser.RULE_gate_instantiation = 19;
vlgParser.RULE_gate_type = 20;
vlgParser.RULE_continuous_assign = 21;
vlgParser.RULE_list_of_net_assignments = 22;
vlgParser.RULE_net_assignment = 23;
vlgParser.RULE_expr = 24;
vlgParser.RULE_binary_gate_op = 25;
...
vlgParser.RULE_seq_block = 32;
vlgParser.RULE_statement = 33;
vlgParser.RULE_blocking_assignment = 34;
vlgParser.RULE_conditional_statement = 35;
vlgParser.RULE_concatenation = 36;
vlgParser.RULE_expression = 37;
vlgParser.RULE_term = 38;
vlgParser.RULE_primary = 39;
vlgParser.RULE_parens_expression = 40;
...
vlgParser.prototype.module_instantiation = function() {
    ...
    this.enterRule(localctx, 32, vlgParser.RULE_module_instantiation);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 218;
...
vlgParser.prototype.module_connections_list = function() {
    ...
    this.enterRule(localctx, 34, vlgParser.RULE_module_connections_list);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 223;
...
vlgParser.prototype.named_port_connection = function() {
    ...
    this.enterRule(localctx, 36, vlgParser.RULE_named_port_connection);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 234;
...
vlgParser.prototype.gate_instantiation = function() {
    ...
    this.enterRule(localctx, 38, vlgParser.RULE_gate_instantiation);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 240;
        this.gate_type();
...
vlgParser.prototype.gate_type = function() {
    ...
    this.enterRule(localctx, 40, vlgParser.RULE_gate_type);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 248;
...
vlgParser.prototype.continuous_assign = function() {
    ...
    this.enterRule(localctx, 42, vlgParser.RULE_continuous_assign);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 250;
...
vlgParser.prototype.list_of_net_assignments = function() {
    ...
    this.enterRule(localctx, 44, vlgParser.RULE_list_of_net_assignments);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 254;
...
vlgParser.prototype.binary_gate_op = function() {
    ...
    this.enterRule(localctx, 50, vlgParser.RULE_binary_gate_op);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 285;
...
vlgParser.prototype.seq_block = function() {
    ...
    this.enterRule(localctx, 64, vlgParser.RULE_seq_block);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 319;
...
vlgParser.prototype.conditional_statement = function() {
    ...
    this.enterRule(localctx, 70, vlgParser.RULE_conditional_statement);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 339;
...
vlgParser.prototype.concatenation = function() {
    ...
    this.enterRule(localctx, 72, vlgParser.RULE_concatenation);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 348;
...
vlgParser.prototype.expression = function() {
    ...
    this.enterRule(localctx, 74, vlgParser.RULE_expression);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 359;
...
vlgParser.prototype.term = function() {
    ...
    this.enterRule(localctx, 76, vlgParser.RULE_term);
    try {
        this.state = 372;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
vlgParser.prototype.primary = function() {
    ...
    this.enterRule(localctx, 78, vlgParser.RULE_primary);
    try {
        this.state = 378;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
vlgParser.prototype.parens_expression = function() {
    ...
    this.enterRule(localctx, 80, vlgParser.RULE_parens_expression);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 380;
        this.match(vlgParser.T__3);
