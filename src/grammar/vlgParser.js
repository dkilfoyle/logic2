...
var ruleNames =  [ "source_text", "modules", "module_main", "module", "module_ports", 
                   ...
                   "factor", "atom", "lvalue", "unary_operator", "binary_operator", 
...
vlgParser.RULE_factor = 39;
vlgParser.RULE_atom = 40;
vlgParser.RULE_lvalue = 41;
vlgParser.RULE_unary_operator = 42;
vlgParser.RULE_binary_operator = 43;
vlgParser.RULE_number = 44;
vlgParser.RULE_defined_connection_id = 45;
vlgParser.RULE_defined_connection_id_list = 46;
vlgParser.RULE_identifier_list = 47;
vlgParser.RULE_range = 48;
vlgParser.RULE_identifier = 49;
...
function FactorExpressionContext(parser, ctx) {
	ExpressionContext.call(this, parser);
    ExpressionContext.prototype.copyFrom.call(this, ctx);
    return this;
}

FactorExpressionContext.prototype = Object.create(ExpressionContext.prototype);
FactorExpressionContext.prototype.constructor = FactorExpressionContext;

vlgParser.FactorExpressionContext = FactorExpressionContext;

FactorExpressionContext.prototype.factor = function() {
    return this.getTypedRuleContext(FactorContext,0);
};
FactorExpressionContext.prototype.enterRule = function(listener) {
    if(listener instanceof vlgListener ) {
        listener.enterFactorExpression(this);
	}
};

FactorExpressionContext.prototype.exitRule = function(listener) {
    if(listener instanceof vlgListener ) {
        listener.exitFactorExpression(this);
	}
};

FactorExpressionContext.prototype.accept = function(visitor) {
    if ( visitor instanceof vlgVisitor ) {
...
vlgParser.prototype.expression = function(_p) {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        localctx = new FactorExpressionContext(this, localctx);
        this._ctx = localctx;
        _prevctx = localctx;
...
function FactorContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = vlgParser.RULE_factor;
    return this;
}
...
AtomExpressionContext.prototype = Object.create(FactorContext.prototype);
...
ParenExpressionContext.prototype = Object.create(FactorContext.prototype);
ParenExpressionContext.prototype.constructor = ParenExpressionContext;

vlgParser.ParenExpressionContext = ParenExpressionContext;
...
UnaryExpressionContext.prototype = Object.create(FactorContext.prototype);
UnaryExpressionContext.prototype.constructor = UnaryExpressionContext;

vlgParser.UnaryExpressionContext = UnaryExpressionContext;

UnaryExpressionContext.prototype.factor = function() {
    return this.getTypedRuleContext(FactorContext,0);
};
...
vlgParser.FactorContext = FactorContext;

vlgParser.prototype.factor = function() {

    var localctx = new FactorContext(this, this._ctx, this.state);
    this.enterRule(localctx, 78, vlgParser.RULE_factor);
    var _la = 0; // Token type
    try {
        this.state = 397;
        this._errHandler.sync(this);
...
function AtomContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = vlgParser.RULE_atom;
    return this;
}
...
function IdentifierAtomContext(parser, ctx) {
	AtomContext.call(this, parser);
    AtomContext.prototype.copyFrom.call(this, ctx);
    return this;
}

IdentifierAtomContext.prototype = Object.create(AtomContext.prototype);
IdentifierAtomContext.prototype.constructor = IdentifierAtomContext;

vlgParser.IdentifierAtomContext = IdentifierAtomContext;

IdentifierAtomContext.prototype.identifier = function() {
    return this.getTypedRuleContext(IdentifierContext,0);
};
IdentifierAtomContext.prototype.enterRule = function(listener) {
    if(listener instanceof vlgListener ) {
        listener.enterIdentifierAtom(this);
	}
};

IdentifierAtomContext.prototype.exitRule = function(listener) {
    if(listener instanceof vlgListener ) {
        listener.exitIdentifierAtom(this);
	}
};

IdentifierAtomContext.prototype.accept = function(visitor) {
    if ( visitor instanceof vlgVisitor ) {
...
vlgParser.NumberAtomContext = NumberAtomContext;
...
function ConcatenationAtomContext(parser, ctx) {
	AtomContext.call(this, parser);
    AtomContext.prototype.copyFrom.call(this, ctx);
    return this;
}

ConcatenationAtomContext.prototype = Object.create(AtomContext.prototype);
ConcatenationAtomContext.prototype.constructor = ConcatenationAtomContext;

vlgParser.ConcatenationAtomContext = ConcatenationAtomContext;

ConcatenationAtomContext.prototype.concatenation = function() {
    return this.getTypedRuleContext(ConcatenationContext,0);
};
ConcatenationAtomContext.prototype.enterRule = function(listener) {
    if(listener instanceof vlgListener ) {
        listener.enterConcatenationAtom(this);
	}
};

ConcatenationAtomContext.prototype.exitRule = function(listener) {
    if(listener instanceof vlgListener ) {
        listener.exitConcatenationAtom(this);
	}
};

ConcatenationAtomContext.prototype.accept = function(visitor) {
    if ( visitor instanceof vlgVisitor ) {
        return visitor.visitConcatenationAtom(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
vlgParser.AtomContext = AtomContext;

vlgParser.prototype.atom = function() {

    var localctx = new AtomContext(this, this._ctx, this.state);
    this.enterRule(localctx, 80, vlgParser.RULE_atom);
    try {
        this.state = 402;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
        ...
        case vlgParser.Hex_number:
            ...
            break;
        case vlgParser.IDENTIFIER:
            localctx = new IdentifierAtomContext(this, localctx);
            this.enterOuterAlt(localctx, 2);
            this.state = 400;
            this.identifier();
            break;
        case vlgParser.T__12:
            localctx = new ConcatenationAtomContext(this, localctx);
            this.enterOuterAlt(localctx, 3);
            this.state = 401;
            this.concatenation();
            break;
...
vlgParser.prototype.lvalue = function() {
    ...
    this.enterRule(localctx, 82, vlgParser.RULE_lvalue);
    try {
        this.state = 406;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
vlgParser.prototype.unary_operator = function() {
    ...
    this.enterRule(localctx, 84, vlgParser.RULE_unary_operator);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 408;
...
vlgParser.prototype.binary_operator = function() {
    ...
    this.enterRule(localctx, 86, vlgParser.RULE_binary_operator);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 410;
...
vlgParser.prototype.number = function() {
    ...
    this.enterRule(localctx, 88, vlgParser.RULE_number);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 412;
...
vlgParser.prototype.defined_connection_id = function() {
    ...
    this.enterRule(localctx, 90, vlgParser.RULE_defined_connection_id);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 414;
        this.match(vlgParser.IDENTIFIER);
...
vlgParser.prototype.defined_connection_id_list = function() {
    ...
    this.enterRule(localctx, 92, vlgParser.RULE_defined_connection_id_list);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 416;
...
vlgParser.prototype.identifier_list = function() {
    ...
    this.enterRule(localctx, 94, vlgParser.RULE_identifier_list);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 424;
...
vlgParser.prototype.range = function() {
    ...
    this.enterRule(localctx, 96, vlgParser.RULE_range);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 432;
...
vlgParser.prototype.identifier = function() {
    ...
    this.enterRule(localctx, 98, vlgParser.RULE_identifier);
    try {
        this.state = 451;
        this._errHandler.sync(this);
