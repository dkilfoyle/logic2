...
vlgParser.RULE_expression = 43;
vlgParser.RULE_expr = 44;
vlgParser.RULE_binary_gate_op = 45;
vlgParser.RULE_unary_gate_op = 46;
vlgParser.RULE_lvalue = 47;
vlgParser.RULE_unary_operator = 48;
vlgParser.RULE_binary_operator = 49;
vlgParser.RULE_number = 50;
vlgParser.RULE_defined_connection_id = 51;
vlgParser.RULE_defined_connection_id_list = 52;
vlgParser.RULE_identifier_list = 53;
vlgParser.RULE_range = 54;
vlgParser.RULE_identifier = 55;
...
vlgParser.prototype.expression = function(_p) {
    ...
    var _startState = 86;
    this.enterRecursionRule(localctx, 86, vlgParser.RULE_expression, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 447;
...
vlgParser.prototype.expr = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 88;
    this.enterRecursionRule(localctx, 88, vlgParser.RULE_expr, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 478;
        this._errHandler.sync(this);
...
vlgParser.prototype.binary_gate_op = function() {
    ...
    this.enterRule(localctx, 90, vlgParser.RULE_binary_gate_op);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 489;
...
vlgParser.prototype.unary_gate_op = function() {
    ...
    this.enterRule(localctx, 92, vlgParser.RULE_unary_gate_op);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 491;
...
vlgParser.prototype.lvalue = function() {
    ...
    this.enterRule(localctx, 94, vlgParser.RULE_lvalue);
    try {
        this.state = 495;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
vlgParser.prototype.unary_operator = function() {
    ...
    this.enterRule(localctx, 96, vlgParser.RULE_unary_operator);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 497;
...
vlgParser.prototype.binary_operator = function() {
    ...
    this.enterRule(localctx, 98, vlgParser.RULE_binary_operator);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 499;
...
vlgParser.prototype.number = function() {
    ...
    this.enterRule(localctx, 100, vlgParser.RULE_number);
    try {
        this.state = 505;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
vlgParser.prototype.defined_connection_id = function() {
    ...
    this.enterRule(localctx, 102, vlgParser.RULE_defined_connection_id);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 507;
        this.match(vlgParser.IDENTIFIER);
...
vlgParser.prototype.defined_connection_id_list = function() {
    ...
    this.enterRule(localctx, 104, vlgParser.RULE_defined_connection_id_list);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 509;
...
vlgParser.prototype.identifier_list = function() {
    ...
    this.enterRule(localctx, 106, vlgParser.RULE_identifier_list);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 517;
...
vlgParser.prototype.range = function() {
    ...
    this.enterRule(localctx, 108, vlgParser.RULE_range);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 525;
...
vlgParser.prototype.identifier = function() {
    ...
    this.enterRule(localctx, 110, vlgParser.RULE_identifier);
    try {
        this.state = 544;
        this._errHandler.sync(this);
