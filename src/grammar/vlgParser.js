...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, null, null, null, null, null, 
                      "MAIN", "Decimal_number", "Binary_number", "Octal_number", 
...
vlgParser.T__43 = 44;
vlgParser.MAIN = 45;
vlgParser.Decimal_number = 46;
vlgParser.Binary_number = 47;
vlgParser.Octal_number = 48;
vlgParser.Hex_number = 49;
vlgParser.NOT = 50;
vlgParser.NEG = 51;
vlgParser.NAND = 52;
vlgParser.NOR = 53;
...
vlgParser.GTE = 65;
vlgParser.EQUAL = 66;
vlgParser.NOTEQUAL = 67;
vlgParser.One_line_comment = 68;
vlgParser.Block_comment = 69;
vlgParser.IDENTIFIER = 70;
vlgParser.White_space = 71;
...
vlgParser.RULE_initial_construct = 23;
vlgParser.RULE_always_construct = 24;
vlgParser.RULE_event_list = 25;
vlgParser.RULE_event_every = 26;
vlgParser.RULE_event_primary = 27;
vlgParser.RULE_event_type = 28;
vlgParser.RULE_statement_block = 29;
vlgParser.RULE_seq_block = 30;
vlgParser.RULE_statement = 31;
vlgParser.RULE_blocking_assignment = 32;
vlgParser.RULE_conditional_statement = 33;
vlgParser.RULE_case_statement = 34;
vlgParser.RULE_case_clause = 35;
vlgParser.RULE_case_default = 36;
vlgParser.RULE_concatenation = 37;
vlgParser.RULE_expression = 38;
vlgParser.RULE_expr = 39;
vlgParser.RULE_binary_gate_op = 40;
vlgParser.RULE_unary_gate_op = 41;
...
vlgParser.prototype.initial_construct = function() {
    ...
    this.enterRule(localctx, 46, vlgParser.RULE_initial_construct);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 277;
...
vlgParser.prototype.always_construct = function() {
    ...
    this.enterRule(localctx, 48, vlgParser.RULE_always_construct);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 280;
...
vlgParser.prototype.event_list = function() {
    ...
    this.enterRule(localctx, 50, vlgParser.RULE_event_list);
    var _la = 0; // Token type
    try {
        this.state = 298;
        this._errHandler.sync(this);
...
vlgParser.prototype.event_every = function() {
    ...
    this.enterRule(localctx, 52, vlgParser.RULE_event_every);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 300;
...
vlgParser.prototype.event_primary = function() {
    ...
    this.enterRule(localctx, 54, vlgParser.RULE_event_primary);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 303;
...
vlgParser.prototype.event_type = function() {
    ...
    this.enterRule(localctx, 56, vlgParser.RULE_event_type);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 307;
...
vlgParser.prototype.statement_block = function() {
    ...
    this.enterRule(localctx, 58, vlgParser.RULE_statement_block);
    try {
        this.state = 311;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
vlgParser.prototype.seq_block = function() {
    ...
    this.enterRule(localctx, 60, vlgParser.RULE_seq_block);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 313;
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 13)) & ~0x1f) == 0 && ((1 << (_la - 13)) & ((1 << (vlgParser.T__12 - 13)) | (1 << (vlgParser.T__36 - 13)) | (1 << (vlgParser.T__38 - 13)))) !== 0) || _la===vlgParser.IDENTIFIER) {
            this.state = 314;
            this.statement();
            this.state = 319;
            this._errHandler.sync(this);
...
vlgParser.prototype.conditional_statement = function() {
    ...
    this.enterRule(localctx, 66, vlgParser.RULE_conditional_statement);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 333;
...
vlgParser.prototype.case_statement = function() {
    ...
    this.enterRule(localctx, 68, vlgParser.RULE_case_statement);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 342;
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(((((_la - 46)) & ~0x1f) == 0 && ((1 << (_la - 46)) & ((1 << (vlgParser.Decimal_number - 46)) | (1 << (vlgParser.Binary_number - 46)) | (1 << (vlgParser.Octal_number - 46)) | (1 << (vlgParser.Hex_number - 46)))) !== 0));
        this.state = 352;
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===vlgParser.T__41) {
            this.state = 351;
...
vlgParser.prototype.case_clause = function() {
    ...
    this.enterRule(localctx, 70, vlgParser.RULE_case_clause);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 356;
        this.number();
...
vlgParser.prototype.case_default = function() {
    ...
    this.enterRule(localctx, 72, vlgParser.RULE_case_default);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 360;
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 3:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(((((_la - 62)) & ~0x1f) == 0 && ((1 << (_la - 62)) & ((1 << (vlgParser.LT - 62)) | (1 << (vlgParser.LTE - 62)) | (1 << (vlgParser.GT - 62)) | (1 << (vlgParser.GTE - 62)) | (1 << (vlgParser.EQUAL - 62)) | (1 << (vlgParser.NOTEQUAL - 62)))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                    	this._errHandler.reportMatch(this);
...
vlgParser.prototype.expr = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 78;
    this.enterRecursionRule(localctx, 78, vlgParser.RULE_expr, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 410;
        this._errHandler.sync(this);
...
vlgParser.prototype.binary_gate_op = function() {
    ...
    this.enterRule(localctx, 80, vlgParser.RULE_binary_gate_op);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 421;
        _la = this._input.LA(1);
        if(!(((((_la - 52)) & ~0x1f) == 0 && ((1 << (_la - 52)) & ((1 << (vlgParser.NAND - 52)) | (1 << (vlgParser.NOR - 52)) | (1 << (vlgParser.XOR - 52)) | (1 << (vlgParser.AND - 52)) | (1 << (vlgParser.OR - 52)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
vlgParser.prototype.unary_gate_op = function() {
    ...
    this.enterRule(localctx, 82, vlgParser.RULE_unary_gate_op);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 423;
...
vlgParser.prototype.unary_operator = function() {
    ...
    try {
        ...
        this.state = 429;
        _la = this._input.LA(1);
        if(!(((((_la - 50)) & ~0x1f) == 0 && ((1 << (_la - 50)) & ((1 << (vlgParser.NOT - 50)) | (1 << (vlgParser.PLUS - 50)) | (1 << (vlgParser.MINUS - 50)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
vlgParser.prototype.binary_operator = function() {
    ...
    try {
        ...
        this.state = 431;
        _la = this._input.LA(1);
        if(!(((((_la - 56)) & ~0x1f) == 0 && ((1 << (_la - 56)) & ((1 << (vlgParser.PLUS - 56)) | (1 << (vlgParser.MINUS - 56)) | (1 << (vlgParser.MUL - 56)) | (1 << (vlgParser.DIV - 56)) | (1 << (vlgParser.EQUAL - 56)) | (1 << (vlgParser.NOTEQUAL - 56)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
