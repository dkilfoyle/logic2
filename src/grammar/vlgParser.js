...
var ruleNames =  [ "source_text", "modules", "module_main", "module", "module_ports", 
                   ...
                   "concatenation", "expression", "expr", "binary_gate_op", 
...
vlgParser.RULE_seq_block = 29;
vlgParser.RULE_statement = 30;
vlgParser.RULE_blocking_assignment = 31;
vlgParser.RULE_conditional_statement = 32;
vlgParser.RULE_concatenation = 33;
vlgParser.RULE_expression = 34;
vlgParser.RULE_expr = 35;
vlgParser.RULE_binary_gate_op = 36;
vlgParser.RULE_unary_gate_op = 37;
vlgParser.RULE_lvalue = 38;
vlgParser.RULE_unary_operator = 39;
vlgParser.RULE_binary_operator = 40;
vlgParser.RULE_number = 41;
vlgParser.RULE_defined_connection_id = 42;
vlgParser.RULE_defined_connection_id_list = 43;
vlgParser.RULE_identifier_list = 44;
vlgParser.RULE_range = 45;
vlgParser.RULE_identifier = 46;
...
vlgParser.prototype.seq_block = function() {
    ...
    this.enterRule(localctx, 58, vlgParser.RULE_seq_block);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 301;
...
vlgParser.prototype.statement = function() {
    ...
    this.enterRule(localctx, 60, vlgParser.RULE_statement);
    try {
        this.state = 315;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
vlgParser.prototype.blocking_assignment = function() {
    ...
    this.enterRule(localctx, 62, vlgParser.RULE_blocking_assignment);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 317;
...
vlgParser.prototype.conditional_statement = function() {
    ...
    this.enterRule(localctx, 64, vlgParser.RULE_conditional_statement);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 321;
...
vlgParser.prototype.concatenation = function() {
    ...
    this.enterRule(localctx, 66, vlgParser.RULE_concatenation);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 330;
...
vlgParser.prototype.expression = function(_p) {
    ...
    var _startState = 68;
    this.enterRecursionRule(localctx, 68, vlgParser.RULE_expression, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 351;
...
vlgParser.prototype.expr = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 70;
    this.enterRecursionRule(localctx, 70, vlgParser.RULE_expr, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 373;
        this._errHandler.sync(this);
...
vlgParser.prototype.binary_gate_op = function() {
    ...
    this.enterRule(localctx, 72, vlgParser.RULE_binary_gate_op);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 384;
...
vlgParser.prototype.unary_gate_op = function() {
    ...
    this.enterRule(localctx, 74, vlgParser.RULE_unary_gate_op);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 386;
        this.match(vlgParser.NOT);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
vlgParser.prototype.lvalue = function() {
    ...
    this.enterRule(localctx, 76, vlgParser.RULE_lvalue);
    try {
        this.state = 390;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
vlgParser.prototype.unary_operator = function() {
    ...
    this.enterRule(localctx, 78, vlgParser.RULE_unary_operator);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 392;
...
vlgParser.prototype.binary_operator = function() {
    ...
    this.enterRule(localctx, 80, vlgParser.RULE_binary_operator);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 394;
...
vlgParser.prototype.number = function() {
    ...
    this.enterRule(localctx, 82, vlgParser.RULE_number);
    try {
        this.state = 400;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
vlgParser.prototype.defined_connection_id = function() {
    ...
    this.enterRule(localctx, 84, vlgParser.RULE_defined_connection_id);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 402;
        this.match(vlgParser.IDENTIFIER);
...
vlgParser.prototype.defined_connection_id_list = function() {
    ...
    this.enterRule(localctx, 86, vlgParser.RULE_defined_connection_id_list);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 404;
...
vlgParser.prototype.identifier_list = function() {
    ...
    this.enterRule(localctx, 88, vlgParser.RULE_identifier_list);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 412;
...
vlgParser.prototype.range = function() {
    ...
    this.enterRule(localctx, 90, vlgParser.RULE_range);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 420;
...
vlgParser.prototype.identifier = function() {
    ...
    this.enterRule(localctx, 92, vlgParser.RULE_identifier);
    try {
        this.state = 439;
        this._errHandler.sync(this);
