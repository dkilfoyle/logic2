(function(global, factory) {
  ...
  class GenericNodeRenderer {
    ...
    initNodeSizes(d) {
      ...
      d.width =
        max(
          portW * portColums + middleSpacing,
          labelW,
  ...
  class MuxNodeRenderer extends GenericNodeRenderer {
    ...
    selector(node) {
      return (
        node.hwMeta.cls == "Operator" &&
        (node.hwMeta.name === "MUX" || node.hwMeta.name === "LATCHED_MUX")
      );
    }
  ...
  function toAbsolutePositionsEdges(n, nodeMap) {
    ...
    (n.edges || []).forEach(function(e) {
      ...
      var relative = isDescendant(srcNode, tgtNode) ? srcNode : srcNode.parent;
    ...
    start() {
      ...
      if (typeof state !== "undefined") {
        ...
        return this.layouter
          .layout(this.graph, { layoutOptions: this._options })
          .then(this._applyLayout.bind(this), function(e) {
  ...
  exports.GenericNodeRenderer = GenericNodeRenderer; // added by dk to avoid needing to import/webworker problem
